...
export const SignupForm: React.FC = () => {
  ...
  const { signUpUser, signInWithGoogleUser, loading, error, clearError } = useAuthActions()
  ...
  return (
    <div className="bg-white/90 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-white/20 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-primary mb-3">Create Account</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">
            ...
            <Link href="/login" className="text-primary hover:text-accent font-semibold transition-colors duration-200">
              Sign in here
            </Link>
          </p>
        </div>
